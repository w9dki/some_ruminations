/* randn_complex_7.c
  ...
  Using pointer arithmetic, in 1-D and a real for 2-D complex double calloc array (Similar to a FORTAN EQUIALENCE of 
  a 1-D to process a 2-D array.  This is usually the fastest algorithm.

  Compile for gcc-5:

gcc -std=gnu11 -Wall -Ofast -msse2 -frename-registers -malign-double -fno-strict-aliasing -DHAVE_SSE2=1 -DDSFMT_MEXP=19937 -o randn_complex_7 dSFMT.c randn_complex_7.c -lm -lrt -lgsl -lgslcblas

*/

#include <complex.h>                // gnu11  complex numbers for C11
#include <math.h>                   // for sine and cosinemedia
...
{   
   long i;
   double *ptr;
   ptr = r;    // using a FORTRAN equivalence here.  Expect gcc -Wall warnings
